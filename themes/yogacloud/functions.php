...
add_action( 'wp_enqueue_scripts', function(){
	...
	wp_enqueue_script( 'cycle2', 'http://malsup.github.io/jquery.cycle2.js', array('jquery'), '1.0', true );
	wp_enqueue_script( 'cycle2_carousel', 'http://malsup.github.io/jquery.cycle2.carousel.js', array('jquery'), '1.0', true );
	wp_enqueue_script( 'cycle2_tile', 'http://malsup.github.io/jquery.cycle2.tile.js', array('jquery'), '1.0', true );
	...
	wp_localize_script( 'functions', 'isPrueba', (string) is_page('prueba') );
