							...
							<div class="container [ padding-bottom padding-top--small ][ white-text ]">
								...
								<div class="[ footer-menu ]">
									<div class="[ border-bottom--light ][ padding-bottom margin-bottom ]">
										...
										<a href="tel:+525552555555" class="[ white-text ]"><i class="[ icon-phone-circle-1 icon-large inline padding-sides--xsmall ]"></i></a>
										<a href="mailto:contacto@yogacloud.com" class="[ white-text ]"><i class="[ icon-email-circle-1 icon-large inline padding-sides--xsmall ]"></i></a>
									</div>
									<div>
