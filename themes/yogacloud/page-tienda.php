	...
	<section class="[ margin-bottom ]">
		...
		<article>
			<div class="[ card-image ][ relative ][ text-center ]">
				<div style="height: 420px; background-size: cover; background-position: center bottom; background-image: url(<?php echo THEMEPATH; ?>images/tienda4.png)">
		...
		<article>
			<div class="[ card-image ][ relative ][ text-center ]">
				<div style="height: 220px; background-size: cover; background-position: center bottom; background-image: url(<?php echo THEMEPATH; ?>images/tienda4.png)">
